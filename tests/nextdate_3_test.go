...
func TestNextDate(t *testing.T) {
	...
	tbl = []nextDate{
		...
		{"20240826", "m 1 1,2", "20250101"}, // добавлена проверка, если указанный месяц меньше указанной даты
		...
		{"20240125", "w 3,1,2", "20240129"}, // добавлено для теста отправки дней недели не по порядку.
		{"20240126", "w 7", "20240128"},
		{"20230126", "w 4,5", "20240201"},
		{"20250122", "w 4,5", "20250123"}, // добавлено для теста будущей даты.
		{"20230226", "w 8,4,5", ""},
	}
	check()
}
